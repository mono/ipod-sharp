...
namespace Hal
{
    internal struct PropertyModification
    {
        public string Key;
        public bool Added;
        public bool Removed;
    ...
    internal interface IDeviceIPod
    {
        // TODO:
    ...
    internal class PropertyModifiedArgs : EventArgs
    {
    ...
    internal delegate void PropertyModifiedHandler(object o, PropertyModifiedArgs args);

    internal class Device : IEnumerable<KeyValuePair<string, object>>, IEqualityComparer<Device>,
        IEquatable<Device>, IComparer<Device>, IComparable<Device>
    {
        private string udi;
        private IDeviceIPod device;
